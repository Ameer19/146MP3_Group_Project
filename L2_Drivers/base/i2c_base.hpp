...
class I2C_Base
{
    ...
    protected:
        ...
        bool initSlave(uint32_t slaveAddr, uint8_t *regAddr, uint32_t size);
    ...
    private:
        ...
        //master&slave flag, my registers and size
        bool Master1Slave0;
        uint8_t *mRegisters;
        uint8_t mRegisterSize;
         ...
         *              - Read  is complete
         */
        mStateMachineStatus_t i2cSlaveStateMachine(); //my SlaveStateMachine
